...
const sttaddr = "0xD9271Dc419495C12778c0F599d3c9A7285590629";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xD9271Dc419495C12778c0F599d3c9A7285590629";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://appletoken.finance?ref=' + document.getElementById('refaddress').value;
        }
    }
}
